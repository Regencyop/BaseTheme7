...
function productlightbox() {
    ...
    function template() {
        return [
            ...
            '.galleryThumbs .img-thumbnail {border:1px solid #ccc;max-height:121px;max-width:121px;padding:0}',
            '.galleryThumbs .active .img-thumbnail {border:1px solid #777;}',
            ...
            '.galleryImages .active .product-image-large {display:block !important;max-height:600px;max-width:100%;position:relative;top:0;}',
            '</style>',
            ...
            '<img ng-src="{{image.url}}" class="img-thumbnail img-responsive" title={{image.Name}} />',
            '</a>',
            '</li>',
            '</ul>',
            '</div>'
